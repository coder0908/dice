...
#define LIBDICE_LOOKUP_METADATA_LEN 2
#define LIBDICE_LOOKUP_KEY_MAX_LEN 13
#define LIBDICE_LOOKUP_KEY_MIN_LEN 1
#define LIBDICE_LOOKUP_VALUE_MAX_LEN 13
#define LIBDICE_LOOKUP_VALUE_MIN_LEN 0
